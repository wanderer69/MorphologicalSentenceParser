...
const (
	MorphologicalSentenceParser_PutSentenceToParsing_FullMethodName     = "/MorphologicalSentenceParser.MorphologicalSentenceParser/PutSentenceToParsing"
	MorphologicalSentenceParser_GetResultSentenceParsing_FullMethodName = "/MorphologicalSentenceParser.MorphologicalSentenceParser/GetResultSentenceParsing"
)
...
func (c *morphologicalSentenceParserClient) PutSentenceToParsing(ctx context.Context, in *PutSentenceToParsingRequest, opts ...grpc.CallOption) (*PutSentenceToParsingResponse, error) {
	...
	err := c.cc.Invoke(ctx, MorphologicalSentenceParser_PutSentenceToParsing_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *morphologicalSentenceParserClient) GetResultSentenceParsing(ctx context.Context, in *GetResultSentenceParsingRequest, opts ...grpc.CallOption) (*GetResultSentenceParsingResponse, error) {
	...
	err := c.cc.Invoke(ctx, MorphologicalSentenceParser_GetResultSentenceParsing_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MorphologicalSentenceParser_PutSentenceToParsing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MorphologicalSentenceParser_PutSentenceToParsing_FullMethodName,
	}
...
func _MorphologicalSentenceParser_GetResultSentenceParsing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MorphologicalSentenceParser_GetResultSentenceParsing_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
