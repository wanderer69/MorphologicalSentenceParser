...
type WordData struct {
	...
	Feats         map[string]string      `protobuf:"bytes,3,rep,name=Feats,proto3" json:"Feats,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
var file_morphological_sentense_parser_proto_goTypes = []any{
